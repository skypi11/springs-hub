...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Bottom: Discord communauté + user */}
      <div className="p-4">
        ...
        <a
          ...
          className="flex items-center gap-3 px-3 py-2.5 mb-3 transition-all duration-150 group"
          style={{
          ...
          onMouseLeave={(e) => {
            ...
            e.currentTarget.style.borderColor = 'var(--s-border)';
            e.currentTarget.style.color = 'var(--s-text-dim)';
          }}
        >
