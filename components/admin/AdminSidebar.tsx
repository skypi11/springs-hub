...
const ITEMS: NavItem[] = [
  ...
  { href: '/admin/rank-reports', icon: Flag, label: 'Signalements rang', description: 'Rangs RL contestés / smurfs Valorant' },
  { href: '/admin/rl-link-changes', icon: RefreshCw, label: 'Changements Epic', description: 'Demandes de re-liaison RL' },
  { href: '/admin/valorant-link-changes', icon: RefreshCw, label: 'Changements Riot', description: 'Demandes de re-liaison Valorant' },
